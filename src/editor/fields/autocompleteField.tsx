...
export const AutocompleteField: <T extends IRecord>(props: PropsWithChildren<IProps<T>>) => ReactElement<PropsWithChildren<IProps<T>>>
  = anuxUIFunctionComponent('Editor-AutoComplete-Field', ({
    className,
    label,
    get,
    set,
    ...
    return (
      <CustomTag name="anux-editor-autocomplete-field" ref={ref} className={classNames(styles.autocompleteField.root, className)}>
